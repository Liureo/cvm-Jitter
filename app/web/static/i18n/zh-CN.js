...
window.WEB_I18N.zh_CN = {
  ...
  upper_left:"左上",upper_right:"右上",horizontal:"水平",lower_left:"左下",lower_right:"右下",circle:"画圈",
  hold:"按住触发",toggle:"切换触发",always:"持续启用",left:"鼠标左键",right:"鼠标右键",middle:"鼠标中键",side1:"鼠标侧键 1",side2:"鼠标侧键 2",
  pendingTitle:"配置",noChanges:"没有待保存的修改",unsaved:"有未保存的修改",saving:"正在保存…",save:"保存设置",saved:"已保存",
  lanNotice:"已启用局域网访问",synced:"已同步"
};
